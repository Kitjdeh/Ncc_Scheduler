...
object Firebase {
    const val FIREBASE_BOM = "com.google.firebase:firebase-bom:32.2.3"
...
object MaterialCalendar {
    const val MATERIAL_CALENDAR_VIEW = "com.github.prolificinteractive:material-calendarview:2.0.1"
}

object Glide {
    const val GLIDE = "com.github.bumptech.glide:glide:4.16.0"
    const val PROCESSOR = "com.github.bumptech.glide:compiler:4.9.0"
}
